<%@ Page Language="VB" AutoEventWireup="false" CodeFile="profile_picture.aspx.vb" Inherits="user_profile_picture" masterpagefile="~/dir_member/Shared/MasterPages/jcrop.Master" title="Pet | Story" %>
			...
			<div class="col-lg-12">
				<h1 class="page-header">
					<asp:label id="lbl_pk_anthology" runat="server" visible="false"></asp:label>
						<asp:image id="img_anthology" runat="server" imageurl="~/dir_image/pet_stick_figure.jpg" />&nbsp;<asp:label id="lbl_pet_name__navigation" runat="server">Teddy</asp:label>&nbsp;<i><asp:label font-size="16px" id="lbl_pet_tagline" runat="server">Who's a bad dog?</asp:label></i>
				</h1>
			</div>
		</div>

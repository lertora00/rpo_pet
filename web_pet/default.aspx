	...
	<div class="container w">
		<div class="row centered">
			...
			<div class="col-lg-4">
				...
				<p>
					We help you capture the special moments in your pet's journey.
				</p>
			</div>
			<div class="col-lg-4">
				...
				<p>
					Access on your phone, tablet, or computer.  Anytime, day or night.   
				</p>
			</div>

			<div class="col-lg-4">
				<i class="fa fa-trophy"></i>
				<h4>Encouragement included!
				</h4>
				<p>
					We'll ask you questions to help curate a story about your pet.
				</p>
			</div>
		</div>
	</div>
